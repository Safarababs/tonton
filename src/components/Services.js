    ...
    <section className="service" id="service">
      ...
      <div className="box-container">
        ...
        <div className="box">
          ...
          <p>
            Engaging Audiences: Strategizing, curating content, and fostering
        ...
        <div className="box">
          ...
          <p>
            Exploring markets, understanding trends, and interpreting data to
        ...
        <div className="box">
          ...
          <h3>Copywriting</h3>
          <p>
            Copywriting: crafting compelling written content for marketing or
        ...
        <div className="box">
          ...
          <h3>Video Editing</h3>
          <p>
            Editing videos: shaping and refining raw footage into a finished,
